      ...
      <div className=" w-1/2  ">
        ...
        <div className="w-fit mx-auto mt-6 text-center">
          ...
          <div className="w-[300px] text-gray-400">
            I like making dynamic and imaginative products from beginning to
            end. Dedicated to creating user-friendly experiences that
            continuously get better through user feedback.
          </div>
        </div>
