...
export default function Timeline() {
  const TimeLine = [
    {
      ...
      activities: [
        {
          label: "Creates Add-on module from planning to production",
        },
        {
          label: "Creates reports and queries base on user requirements",
        },
        {
          label: "Creates reports and queries base on user requirements",
        },
  ...
  return (
    <div>
      <h1 className="font-semibold text-2xl pb-1 mt-10 TITLE">Experience</h1>
      {TimeLine.map((e, i) => (
        <>
              ...
              <div className="border-l-2 border-dashed border-gray-500 -ml-[60px] pl-[60px]">
                ...
                <div className="flex ">
                  ...
                  <div className="flex flex-wrap gap-x-2 gap-y-1 mt-2">
                    {e.tech.map((ee, ii) => (
                      <>
                        <p className=" px-1  text-xs dark:bg-gray-50   rounded-md border">
                          {ee.label}
                        </p>
                      </>
                    ))}
