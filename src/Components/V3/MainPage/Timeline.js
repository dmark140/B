...
import { ExpressIcon, IconVisualStudio, NodeJsIcon, PhpIcon, PostManIcon, ReactColorIcon, SAPIcon, SAPSQL, TailwindIcon, gitHubIcon, msSqlIcon, mysqlIcon } from "../../Components";
  ...
  const TimeLine = [
    {
      ...
      activities: [
            ...
            {label: "Designing in-house third-party programs according to user needs",}, 
            {label: "Constructing Add-on modules on SAP B1 using SDK and Service Layer",}, 
            ...
            {label: "Conducting end-user training for effective use of SAP B1 and in-house third-party programs",}, 
      ],
      tech: [
        {
          icon:ReactColorIcon,
          ...
          <div className="flex w-full p-2 rounded-lg XALAC hover:bg-opacity-10 dark:hover:bg-opacity-10 hover:bg-white dark:hover:bg-black ">
            ...
            <div className="w-full">
              ...
              <div className="border-l-2 border-dashed border-gray-500 -ml-[60px] pl-[60px]">
                ...
                <div className="my-2">
                  {e.activities.length  > 0 && <p className="text-sm mt-2 font-semibold">Activities</p>}
